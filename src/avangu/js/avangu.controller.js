...
.controller("AvanguController", ["$scope", "$window", "$AvguConfig", "$AvguFullscreen", "$AVGU_STATES", function ($scope, $window, $AvguConfig, $AvguFullscreen, $AVGU_STATES) {
    ...
    this.play = function() {
        ...
        player.log("PLAYING >", player.state);
    }
    ...
    this.pause = function() {
        ...
        player.log("PAUSED ||", player.state);
    }
   ...
   /**
    ...
    this.setTime = function(value) {
        ...
        try {
            ...
            player.log(".::: Error: setting time :::.", e);
        }
    ...
    this.onChangeSource = function(source) {
        ...
        player.log(".::: EVENT: Changing/setting Source :::.", source);
    }
    ...
    this.onComplete = function() {
        ...
        player.log(".::: EVENT::: COMPLETE :::.", player.state);
    }
    ...
    this.onPlay = function() {
        ...
        player.log(".::: EVENT::: PLAY :::.", player.state);
    }
    ...
    this.onPause = function() {
        ...
        $scope.$apply();
        player.log(".::: EVENT::: PAUSE :::.", player.state);
    }
    ...
    this.onVolumeChange = function() {
        ...
        player.log(".::: EVENT::: VOLUME CHANGE :::.");
    }
    ...
    this.onPlaybackChange = function() {
        ...
        player.log(".::: EVENT::: PLAYBACK CHANGE :::.");
    }
    ...
    this.ready = function() {
        ...
        player.log(".::: avangu player is ready :::.", player.state);
    }
    ...
    this.createListeners = function() {
        ...
        player.log(".::: creating avangu event Listeners :::.");
    }
    ...
    this.init = function() {
        ...
        player.log(".::: initializing avangu player :::.");
    }
